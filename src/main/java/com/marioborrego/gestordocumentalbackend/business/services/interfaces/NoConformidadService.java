...
public interface NoConformidadService {
    ...
    boolean crearPuntoNoConformidad(NuevoPuntoNcDTO respuestaNoConformidadesProyectoDto);
    boolean crearNoConformidad(CrearNoConformidadDto crearNoConformidadDto);
}
